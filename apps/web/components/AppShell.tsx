...
// Menu order: Daily Queue, Appointments, Patients, Analytics, Administration (last for managers)
const navItems: NavItem[] = [
  ...
  },
  {
    href: '/app/reports',
    label: 'Reports',
    roles: ['manager', 'staff', 'doctor'], // All roles can view reports (with RBAC filtering)
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    href: '/app/analytics',
    label: 'Analytics',
    roles: ['manager', 'staff', 'doctor'], // All roles can view analytics
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          ...
          <div className="flex items-center h-16 px-4 border-b border-gray-200">
            <Link href="/app/queue" className="flex items-center gap-2">
